...
public class DialogManager : MonoBehaviour
{
    ...
    {
        GameObject.Find("Player").GetComponent<PauseControl>().CanPause = true; //Нельзя ставить на паузу во время диалогов
    ...
    {
        GameObject.Find("Player").GetComponent<PauseControl>().CanPause = false; //Нельзя ставить на паузу во время диалогов
        Time.timeScale = 0;
        currentLine = 0;
